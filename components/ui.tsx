...
export const Select: React.FC<SelectProps> = ({ label, id, children, ...props }) => (
    <div>
        ...
        <div className="relative">
            <select
                id={id}
                className="w-full bg-surface border border-border rounded-md px-3 py-2 text-text-primary focus:outline-none focus:ring-2 focus:ring-primary appearance-none pr-8 truncate"
                {...props}
            >
                {children}
            </select>
